	...
	public UpdateCheck() throws SQLException {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText(); //roomnumber;    
		...
		btnAdd.addActionListener(new ActionListener() {
            ...
            if (rs1.next()) {
                ...
                JOptionPane.showMessageDialog(null, "No customer found with this number.");
            }

        } catch (Exception ee) {
            ee.printStackTrace(); // Log the exception for debugging purposes
        }
